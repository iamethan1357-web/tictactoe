...
export default function ProfileModal({ user, onClose, onUpdate }: ProfileModalProps) {
  ...
  return (
    <div
      ...
      style={{ background: "rgba(160, 170, 185, 0.7)", backdropFilter: "blur(4px)" }}
    >
      <div className="neo-card w-full max-w-md animate-slide-up">
        <div className="flex items-center justify-between mb-6">
          ...
          <button onClick={onClose} className="neo-btn px-3 py-1 text-sm rounded-lg">
            ✕
          </button>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="neo-pressed p-3 rounded-xl text-sm" style={{ color: "#718096" }}>
            @{user.username}
          </div>
        </div>
        ...
        {/* Stats */}
        <div className="neo-pressed p-4 rounded-xl mb-6">
          <h3 className="text-xs font-semibold mb-3 uppercase tracking-wider" style={{ color: "#718096" }}>
            Your Stats
          </h3>
        ...
        <button
          onClick={handleSave}
          disabled={saving}
          className="neo-btn-accent w-full py-3 rounded-xl"
        >
