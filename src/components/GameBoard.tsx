      ...
      {status === "finished" && (
        <div className="neo-card mt-4 text-center animate-slide-up">
          ...
          {playerWon && isLevelMode && (
            <p className="text-sm mb-2" style={{ color: "#00b894" }}>
              ✅ Level {level} Complete!
            </p>
          )}
          {winner === "O" && mode === "ai" && (
            <p className="text-sm mb-2" style={{ color: "#e17055" }}>
              Better luck next time!
            </p>
          )}
          {winner === "draw" && (
            <p className="text-sm mb-2" style={{ color: "#fdcb6e" }}>
              So close! Try again.
            </p>
          )}
          ...
          <div className="flex flex-col gap-3 mt-4 max-w-[260px] mx-auto">
            ...
            {/* NEXT LEVEL → shown when user wins a level */}
            ...
            {/* RETRY → shown when user loses or draws a level */}
            ...
            {/* PLAY AGAIN → shown on free-play AI games (not levels) */}
            ...
            {/* TRY AGAIN → shown on daily challenge */}
            {isDaily && onPlayAgain && (
              <button onClick={onPlayAgain} className="neo-btn-accent w-full py-3 text-base rounded-xl flex items-center justify-center gap-2">
                🔄 Try Again
              </button>
            ...
            {isLevelMode && playerWon && nextLvl && nextLvl > 100 && (
              <p className="text-sm font-bold mt-2" style={{ color: "#00b894" }}>
                🏆 You completed all 100 levels! Champion!
              </p>
            )}
          </div>
        </div>
